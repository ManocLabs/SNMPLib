package SNMPLib::Device::CiscoVGW;
...
my @MIB_list = (  'RFC1213' ,'BRIDGE' , 'CISCO_VTP', 'CISCO_CDP', 'IP', 'CISCO_STACK', 'ISDN',
	         'CISCO_PORT_SECURITY', 'CISCO_VLAN_MEMB' , 'IF_TABLE_REL' , 'CISCO_VTP','ETHERLIKE' );#$ref);



__PACKAGE__->set_dev('CiscoVGW');
...
__PACKAGE__->set_session_method('model', sub{return 'Cisco Voice Gateway';});

__PACKAGE__->set_session_method('class_name', sub{return 'Device::CiscoVGW';} );
