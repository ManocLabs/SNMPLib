package SNMPLib::Device::Cisco2900;
...
my @MIB_list = (  'RFC1213' ,'BRIDGE' , 'CISCO_VTP', 'CISCO_CDP', 'IP', 'CISCO_2900',
		  'CISCO_PORT_SECURITY', 'CISCO_VLAN_MEMB' , 'IF_TABLE_REL' , 
		  'CISCO_VTP','ETHERLIKE' );

__PACKAGE__->set_dev('Cisco2900');
...
__PACKAGE__->set_session_method('class_name', sub{return 'Device::C2900';} );
