package SNMPLib::Device::CiscoWism;
...
__PACKAGE__->set_session_method('model', sub{return 'Cisco Wism';});

__PACKAGE__->set_session_method('class_name', sub{return 'Device::CiscoWism';} );
